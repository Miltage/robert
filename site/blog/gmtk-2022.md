...
This past weekend saw the return of the [GMTK Game Jam](https://itch.io/jam/gmtk-jam-2022), the third one in a row. This time the theme was **Roll of the Dice**, which is quite open-ended if you ask me (almost every board game has a dice rolling mechanic in it somewhere. It is the easiest way to generate random numbers in a real world setting, after all.)
